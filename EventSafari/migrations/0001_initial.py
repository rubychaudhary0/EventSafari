    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_description', models.TextField(blank=True, max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_capacity', models.IntegerField(default=1)),
                ('event_price', models.FloatField()),
                ('event_image', models.ImageField(upload_to='')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('organizer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EventSafari.organizer')),
            ],
        ),
    ]
