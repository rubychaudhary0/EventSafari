...
from django.contrib.auth.models import User, AbstractUser, AbstractBaseUser, PermissionsMixin, Group, Permission
...
class Audience(AbstractUser):
    ...
    user_type = models.CharField(max_length=20, choices=[("audience", "Audience")], default="audience")
...
class Organizer(AbstractBaseUser, PermissionsMixin):
    ...
    user_type = models.CharField(max_length=20, choices=[("organizer", "Organizer")], default="organizer")
    email = models.EmailField(_('email address'), unique=True)
    name = models.CharField(max_length=150)
