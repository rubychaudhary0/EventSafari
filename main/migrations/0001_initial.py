# Generated by Django 4.2.6 on 2023-12-17 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Music and Dance', 'Music and Dance'), ('Sports', 'Sports'), ('Religious', 'Religious'), ('Yoga and Meditation', 'Yoga and Meditation'), ('Other', 'Other')], max_length=100, unique=True)),
                ('image', models.ImageField(default='default_banner.png', upload_to='event_images')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.organizer')),
            ],
        ),
    ]
